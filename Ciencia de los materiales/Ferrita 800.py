...
fact1 = (56000*9*10**-6)/(300*126.67*10**-6)
b1 = a2 * fact1
b2 = a4 * fact1
b3 = a6 * fact1
b4 = a8 * fact1
...
fact2 = 100/(np.pi*48.275*10**-3 *20)
h1 = a1 * fact2
h2 = a3 * fact2
h3 = a5 * fact2
h4 = a7 * fact2
...
print("La potencia potencia consumida es:" , "{0: .2f}". format(area_encerrada(a15, a16)* 190.21*10**-6 * 50),"J/m^3")
...
fig2 = plt.figure(num=None, figsize=(9, 5), dpi=160, facecolor='w', edgecolor='k')
...
ax4.set_ylabel('Bm/Hm',fontsize=15)
