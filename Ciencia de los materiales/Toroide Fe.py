...
fact1 = (56000*9*10**-6)/(300* (2248*10**-6))
b1 = a2 * fact1
b2 = a4 * fact1
b3 = a6 * fact1
b4 = a8 * fact1
...
fact2 = 100/(2* np.pi* (53.5/2)*10**-3 *20)
h1 = a1 * fact2
h2 = a3 * fact2
h3 = a5 * fact2
h4 = a7 * fact2
...
def area_encerrada(x_coords, y_coords):
    ...
    '''
    Calcula el área encerrada por una gráfica dadas dos listas 
    de coordenadas (x,y) utilizando el método del trapecio.
    '''
    area = 0.0
    n = len(a15)
...
print("La potencia potencia consumida es:" , "{0: .2f}". format(area_encerrada(a15, a16)* 236.45*10**-6 * 50),"J/m^3")
...
'''
'Gafrico VB'
fig5 = plt.figure(num=None, figsize=(8, 6), dpi=160, facecolor='w', edgecolor='k')
ax5 = fig5.add_subplot(111)

x = np.linspace(1,4000,3999)
ax5.plot(x*2*10**-5,a2)
ax5.plot(x*2*10**-5,a1)
'''
