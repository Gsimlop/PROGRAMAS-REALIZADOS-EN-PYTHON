...
fact1 = (56000*9*10**-6)/(300*1928.31 *10**-6)
b1 = a2 * fact1
b2 = a4 * fact1
b3 = a6 * fact1
b4 = a8 * fact1
...
print("La potencia potencia consumida es:" , "{0: .2f}". format(area_encerrada(a15, a16)* 239.46*10**-6 * 50),"J/m^3")

'Graficamos V'   

fig1 = plt.figure(num=None, figsize=(8, 6), dpi=160, facecolor='w', edgecolor='k')
...
ax1.set_xlabel('VH',fontsize=20)
ax1.set_ylabel('VB',fontsize=20)
...
fig2 = plt.figure(num=None, figsize=(8, 6), dpi=160, facecolor='w', edgecolor='k')
...
fig3 = plt.figure(num=None, figsize=(8, 6), dpi=160, facecolor='w', edgecolor='k')
ax3 = fig3.add_subplot(111)
ax3.set_title('Curva permeabilidad',fontsize=20)
##############################
...
ax3.set_xlabel('Hb',fontsize=20)
ax3.set_ylabel('Bm/Hb',fontsize=20)
...
fig4 = plt.figure(num=None, figsize=(8, 6), dpi=160, facecolor='w', edgecolor='k')
ax4 = fig4.add_subplot(111)
ax4.set_title('Permeabilidad',fontsize=20)
##############################
...
ax4.set_xlabel('maxH',fontsize=20)
ax4.set_ylabel('maxB',fontsize=20)
